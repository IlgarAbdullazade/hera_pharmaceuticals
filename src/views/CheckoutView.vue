  ...
  <div class="page__checkout checkout">
    <div class="checkout__container">
      <div class="checkout__wrapper">
        <div class="checkout__content checkout-content">
          <Form class="checkout-content__body">
            ...
            <div class="checkout-content__col">
                ...
                <div class="checkout-list__item checkout-product">
                  <div class="checkout-product__wrapper">
                    <div class="checkout-product__name">
                      NOVO NORDISK NORDITROPIN SIMPLEXX 5MG (15IU) - SOMATROPINE
                      - 191 AMINO ACID
                    </div>
                    <div
                      data-name="Subtotal"
              ...
              <div class="checkout-content__info">
                Your personal data will be used only to process your order,
